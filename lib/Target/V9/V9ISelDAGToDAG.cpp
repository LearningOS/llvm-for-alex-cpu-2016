//===-- V9ISelDAGToDAG.cpp - A dag to dag inst selector for V9 ------===//
//
...
//===--------------------------------------------------------------------===//
/// V9DAGToDAGISel - SPARC specific code to select SPARC machine
/// instructions for SelectionDAG operations.
///
namespace {
class V9DAGToDAGISel : public SelectionDAGISel {
  /// Subtarget - Keep a pointer to the V9 Subtarget around so that we can
  /// make the right decision when generating code for different targets.
  const V9Subtarget *Subtarget;
public:
  explicit V9DAGToDAGISel(V9TargetMachine &tm) : SelectionDAGISel(tm) {}

  bool runOnMachineFunction(MachineFunction &MF) override {
    Subtarget = &MF.getSubtarget<V9Subtarget>();
...
SDNode* V9DAGToDAGISel::getGlobalBaseReg() {
...
bool V9DAGToDAGISel::SelectADDRri(SDValue Addr,
...
bool V9DAGToDAGISel::SelectADDRrr(SDValue Addr, SDValue &R1, SDValue &R2) {
...
SDNode *V9DAGToDAGISel::SelectInlineAsm(SDNode *N){
...
SDNode *V9DAGToDAGISel::Select(SDNode *N) {
  SDLoc dl(N);
...
/// inline asm expressions.
bool
V9DAGToDAGISel::SelectInlineAsmMemoryOperand(const SDValue &Op,
                                                unsigned ConstraintID,
...
/// createV9ISelDag - This pass converts a legalized DAG into a
/// SPARC-specific DAG, ready for instruction scheduling.
///
FunctionPass *llvm::createV9ISelDag(V9TargetMachine &TM) {
  return new V9DAGToDAGISel(TM);
}
