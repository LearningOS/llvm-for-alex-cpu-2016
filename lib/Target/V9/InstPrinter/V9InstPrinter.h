//===-- V9InstPrinter.h - Convert V9 MCInst to assembly syntax ------===//
//
...
class V9InstPrinter : public MCInstPrinter {
public:
  V9InstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
  ...
  bool printV9AliasInstr(const MCInst *MI, const MCSubtargetInfo &STI,
                            raw_ostream &OS);
