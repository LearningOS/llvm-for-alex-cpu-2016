...
static cl::opt<bool> DisableDelaySlotFiller(
  ...
  cl::init(false),
  cl::desc("Disable the V9 delay slot filler."),
  cl::Hidden);
...
namespace {
  struct Filler : public MachineFunctionPass {
    ...
    bool runOnMachineFunction(MachineFunction &F) override {
      bool Changed = false;
      Subtarget = &F.getSubtarget<V9Subtarget>();
...
/// createV9DelaySlotFillerPass - Returns a pass that fills in delay
/// slots in V9 MachineFunctions
///
FunctionPass *llvm::createV9DelaySlotFillerPass(TargetMachine &tm) {
...
bool Filler::runOnMachineBasicBlock(MachineBasicBlock &MBB) {
  bool Changed = false;
  Subtarget = &MBB.getParent()->getSubtarget<V9Subtarget>();
