//===-- V9ISelLowering.h - V9 DAG Lowering Interface ------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that V9 uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//
...
namespace llvm {
  ...
  class V9TargetLowering : public TargetLowering {
    const V9Subtarget *Subtarget;
  public:
    V9TargetLowering(TargetMachine &TM, const V9Subtarget &STI);
